...
def Transpose_379(spark: SparkSession, in0: DataFrame) -> DataFrame:
    ...
    out0 = transpose_dataframe(
        in0,
        ["GL", "Description"],
        ["Tech", "Quality", "Pharmacovigilance", "Human Resources", "Regulatory", "Finance", "CfOR", "Procurement",
         "Compliance", "G&A Other", "GCO", "Legal", "Mfg", "Ops - Process Development", "Others",
         "R&D - Others", "Supply Chain"]
    )
