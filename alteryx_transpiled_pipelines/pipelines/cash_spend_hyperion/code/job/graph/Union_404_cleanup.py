...
def Union_404_cleanup(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("_Sub_group_flag").alias("Sub_group_flag"), 
        ...
        col("`_SUB-GROUP_Temp`").alias("SUB-GROUP_Temp"), 
