...
def Formula_311(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("`Non-Opex Adjustments Amount`").alias("Non-Opex Adjustments Amount"), 
        ...
        (col("`Non-Opex Adjustments Amount`") * col("`% Split`")).cast(DoubleType()).alias("Non-Opex Adjustments")
    )
