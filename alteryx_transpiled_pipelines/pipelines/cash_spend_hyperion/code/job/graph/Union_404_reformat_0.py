...
def Union_404_reformat_0(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        lit(None).cast(StringType()).alias("_GL"), 
        ...
        col("`_SUB-GROUP_Temp`").alias("_SUB-GROUP_Temp"), 
        col("_Site"), 
        col("_Sub_group_flag"), 
        col("`_Sum of Commitment Amount`").alias("_Sum of Commitment Amount"), 
        col("`_company code name`").alias("_company code name"), 
        col("`_company code number`").cast(StringType()).alias("_company code number"), 
        ...
        col("`_source_vendor - vendor global ultimate parent (enriched) temp1`")\
          .alias("_source_vendor - vendor global ultimate parent (enriched) temp1"), 
