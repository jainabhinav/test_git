...
def Union_46_reformat_0(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("LCL"), 
        col("LCLCFX"), 
        ...
        col("`acct level 3`").cast(StringType()).alias("acct level 3"), 
        col("`acct level 4`").cast(StringType()).alias("acct level 4"), 
        ...
        col("`gl account number`").cast(StringType()).alias("gl account number"), 
        col("hlmc"), 
        col("`local currency`").alias("local currency"), 
        col("`material group`").cast(StringType()).alias("material group"), 
        col("mc"), 
        col("`pa account desc`").alias("pa account desc"), 
        col("`planning sku`").cast(StringType()).alias("planning sku"), 
