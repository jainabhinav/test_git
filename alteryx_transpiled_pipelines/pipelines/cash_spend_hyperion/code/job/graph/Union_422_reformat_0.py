...
def Union_422_reformat_0(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("`_Exclusion Type`").alias("_Exclusion Type"), 
        col("`_Regrouped Level 4`").alias("_Regrouped Level 4"), 
        col("_Site"), 
        lit(None).cast(DoubleType()).alias("_Sum_LCL"), 
        col("_Sum_LCLCFX"), 
        lit(None).cast(DoubleType()).alias("_Sum_USDAFX"), 
        col("_category"), 
        lit(None).cast(StringType()).alias("_category code"), 
        col("_company"), 
        ...
        lit(None).cast(DoubleType()).alias("_planning sku"), 
