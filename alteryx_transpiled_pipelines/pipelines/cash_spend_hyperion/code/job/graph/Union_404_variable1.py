...
def Union_404_variable1(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("`SUB-GROUP_Temp`").alias("_SUB-GROUP_Temp"), 
        ...
        col("Sub_group_flag").alias("_Sub_group_flag"), 
