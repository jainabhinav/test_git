...
def Transpose_300(spark: SparkSession, in0: DataFrame) -> DataFrame:
    ...
    out0 = transpose_dataframe(
        in0,
        ["Mega Category"],
        ["2024 Non-Opex Adjustment", "2025 Non-Opex Adjustment", "2026 Non-Opex Adjustment", "2027 Non-Opex Adjustment"]
    )
