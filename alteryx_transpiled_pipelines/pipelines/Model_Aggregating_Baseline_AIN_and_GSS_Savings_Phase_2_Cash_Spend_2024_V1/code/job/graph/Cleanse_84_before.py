...
def Cleanse_84_before(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("`In-Scope`").alias("In__Scope"), 
        col("`Non-Opex Adjustments`").alias("Non__Opex Adjustments"), 
        col("`In-Scope Final`").alias("In__Scope Final")
    )
