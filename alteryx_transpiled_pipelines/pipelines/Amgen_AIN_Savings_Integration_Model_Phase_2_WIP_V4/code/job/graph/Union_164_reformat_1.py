...
def Union_164_reformat_1(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("Right_Function").cast(StringType()).alias("Right_Function"), 
        lit(None).cast(StringType()).alias("Right_Right_Key"), 
        col("`Right_Right_Right_Right_tableau display mega category`")\
          .cast(StringType())\
          .alias("Right_Right_Right_Right_tableau display mega category"), 
