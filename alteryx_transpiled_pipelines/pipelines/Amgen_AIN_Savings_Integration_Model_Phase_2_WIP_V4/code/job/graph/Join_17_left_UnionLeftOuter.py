...
def Join_17_left_UnionLeftOuter(spark: SparkSession, in0: DataFrame, in1: DataFrame, ) -> DataFrame:
    return in0\
        .alias("in0")\
        ...
        col("in0.GL").alias("GL"), 
        col("in1.`CC Lookup`").alias("CC Lookup"), 
        ...
        col("in1.`CTS v3 CC`").alias("CTS v3 CC"), 
