...
def Join_25_inner(spark: SparkSession, in0: DataFrame, in1: DataFrame, ) -> DataFrame:
    return in0\
        .alias("in0")\
        .join(in1.alias("in1"), ((col("in0.GL") == col("in1.GL")) & (col("in0.`CTS v3`") == col("in1.Name"))), "inner")\
        .select(
        col("in1.Name").alias("Name"), 
        ...
        col("in1.`OSE Labor`").alias("OSE Labor"), 
        col("in1.Description").alias("Description"), 
        col("in0.GL").alias("GL"), 
