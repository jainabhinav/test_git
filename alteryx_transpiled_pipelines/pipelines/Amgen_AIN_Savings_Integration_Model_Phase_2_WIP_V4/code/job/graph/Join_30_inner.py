...
def Join_30_inner(spark: SparkSession, in0: DataFrame, in1: DataFrame, ) -> DataFrame:
    return in0\
        .alias("in0")\
        .join(in1.alias("in1"), (col("in0.`source_cost center number`") == col("in1.`CC Lookup`")), "inner")\
        .select(
