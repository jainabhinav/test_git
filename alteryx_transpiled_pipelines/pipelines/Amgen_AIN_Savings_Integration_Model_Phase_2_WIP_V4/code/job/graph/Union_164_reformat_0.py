...
def Union_164_reformat_0(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        lit(None).cast(StringType()).alias("Right_Function"), 
        col("Right_Right_Key").cast(StringType()).alias("Right_Right_Key"), 
        lit(None).cast(StringType()).alias("Right_Right_Right_Right_tableau display mega category"), 
