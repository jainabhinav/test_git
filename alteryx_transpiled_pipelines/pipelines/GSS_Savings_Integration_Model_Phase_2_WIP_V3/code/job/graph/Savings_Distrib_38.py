...
def Savings_Distrib_38(spark: SparkSession) -> DataFrame:
    return spark.read\
        .schema(
          StructType([
        ...
        .option("header", True)\
        .option("sep", ",")\
        .csv("C:\\Users\\nikhil.f.bansal\\Amgen\\Amgen India - 08.15 Baseline Analytics Engine and Dashboards\\Data Shared by ACN\\Savings Ingestion\\GSS Enterprise Savings\\02. Source Data for the Model\\Savings % Distribution by EVP.xlsx|||`BAU$`")
