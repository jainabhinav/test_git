package io.prophecy.pipelines.first.functions
...
object ColumnFunctions extends Serializable {
  ...
  def f_get_pricing_term(term_id: Column, pricing_terms: Column): Column =
    when(
      is_not_null(
        when(is_not_null(pricing_terms), pricing_terms).otherwise(
          lit(null).cast(
            ArrayType(
              StructType(
                List(
  ...
  def f_viewdef_definition_id(
    ...
    l_viewdef_definition_id =
      ...
      ).when(is_not_null(preempt_viewdef_definition_id_buyer_member),
  ...
  def f_drop_is_deduction_pricing_terms(unfiltered_terms: Column): Column =
    when(is_not_null(unfiltered_terms),
         temp3256870_UDF(unfiltered_terms, unfiltered_terms, lit(0))
  ...
  def f_get_transaction_event_pricing(
    ...
    l_transaction_event_pricing = struct(
      ...
      struct(
        when(is_not_null(buyer_charges), buyer_charges.getField("rate_card_id"))
          .otherwise(
            impression_transaction_event_pricing
          ...
          .as("rate_card_id"),
        when(is_not_null(buyer_charges), buyer_charges.getField("member_id"))
          .otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
              .getField("member_id")
          ...
          .as("member_id"),
        when(is_not_null(buyer_charges), buyer_charges.getField("is_dw"))
          .otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
              .getField("is_dw")
        ...
        impression_transaction_event_pricing
          ...
          .as("pricing_terms"),
        when(is_not_null(buyer_charges),
             buyer_charges.getField("fx_margin_rate_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
        ...
        when(is_not_null(buyer_charges),
             buyer_charges.getField("marketplace_owner_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
        ...
        when(is_not_null(buyer_charges),
             buyer_charges.getField("virtual_marketplace_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
        ...
        when(is_not_null(buyer_charges),
             buyer_charges.getField("amino_enabled")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("buyer_charges")
      ...
      struct(
        when(is_not_null(seller_charges),
             seller_charges.getField("rate_card_id")
        ).otherwise(
            impression_transaction_event_pricing
          ...
          .as("rate_card_id"),
        when(is_not_null(seller_charges), seller_charges.getField("member_id"))
          .otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("member_id")
          ...
          .as("member_id"),
        when(is_not_null(seller_charges), seller_charges.getField("is_dw"))
          .otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("is_dw")
        ...
        impression_transaction_event_pricing
          ...
          .as("pricing_terms"),
        when(is_not_null(seller_charges),
             seller_charges.getField("fx_margin_rate_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("fx_margin_rate_id")
          ...
          .as("fx_margin_rate_id"),
        when(is_not_null(seller_charges),
             seller_charges.getField("marketplace_owner_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("marketplace_owner_id")
          ...
          .as("marketplace_owner_id"),
        when(is_not_null(seller_charges),
             seller_charges.getField("virtual_marketplace_id")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("virtual_marketplace_id")
          ...
          .as("virtual_marketplace_id"),
        when(is_not_null(seller_charges),
             seller_charges.getField("amino_enabled")
        ).otherwise(
            impression_transaction_event_pricing
              .getField("seller_charges")
              .getField("amino_enabled")
  ...
  def f_view_non_measurable_reason(
    ...
    l_view_non_measurable_reason = when(view_detection_enabled === lit(0),
                                        lit(1)
    ).when(isnull(impbus_view_result), lit(2))
  ...
  def f_transaction_event(
    ...
    l_transaction_event = when(
      is_not_null(preempt_transaction_def),
      coalesce(preempt_transaction_def.getField("transaction_event"), lit(0))
    ).when(is_not_null(impression_transaction_def),
  ...
  def f_preempt_over_impression(
    ...
    when(is_not_null(preempt_value), preempt_value).otherwise(impression_value)
  ...
  def f_should_zero_seller_revenue(
    ...
    l_advertiser_id = when(is_not_null(bid),
  ...
  def f_get_curator_margin(pricing_terms: Column): Column =
    when(is_not_null(pricing_terms),
         temp634656_UDF(lit(0), lit(0), lit(0), pricing_terms, lit(0)).getField(
           "l_curator_margin"
         )
    ).otherwise(lit(0))
  ...
  def f_get_total_tech_fees(pricing_terms: Column): Column =
    when(is_not_null(pricing_terms),
         temp1344271_UDF(lit(0), lit(0), lit(0), pricing_terms, lit(0))
           .getField("l_total_tech_fees")
    ).otherwise(lit(0))

  def f_get_seller_fees(pricing_terms: Column): Column =
    when(is_not_null(pricing_terms),
         temp2053714_UDF(lit(0), lit(0), lit(0), pricing_terms, lit(0))
  ...
  def f_get_is_curator_margin_media_cost_dependent(
    ...
    when(is_not_null(pricing_terms),
         temp3471027_UDF(lit(0), pricing_terms, lit(0), lit(0)).getField(
  ...
  def f_get_curator_margin_type(pricing_terms: Column): Column =
    when(is_not_null(pricing_terms),
         temp4180587_UDF(lit(0), pricing_terms, lit(0), lit(0)).getField(
  ...
  def f_convert_log_impbus_imptracker_to_log_impbus_impressions_pricing()
    : Column =
    struct(
      struct(col("*")).getField("date_time").cast(LongType).as("date_time"),
      struct(col("*"))
      ...
      struct(
        ...
        lit(null).cast(BooleanType).as("is_dw"),
        lit(null)
          .cast(
            ArrayType(
              StructType(
      ...
      struct(
        lit(null).cast(IntegerType).as("applied_term_id"),
        lit(null).cast(IntegerType).as("applied_term_type"),
        lit(null).cast(ArrayType(IntegerType, true)).as("targeted_term_ids")
      ...
      lit(null).cast(DoubleType).as("estimated_audience_imps"),
      lit(null).cast(DoubleType).as("audience_imps")
    )
  ...
  def f_convert_log_dw_imptracker_to_log_dw_bid(): Column =
    struct(
      ...
      struct(col("*"))
        ...
        .as("auction_id_64"),
      lit(0.0d).as("price"),
      struct(col("*")).getField("member_id").cast(IntegerType).as("member_id"),
      struct(col("*"))
      ...
      struct(
        lit(null).cast(LongType).as("total_partner_fees_microcents"),
        lit(null).cast(DoubleType).as("booked_revenue_dollars"),
        lit(null).cast(DoubleType).as("booked_revenue_adv_curr"),
        lit(null).cast(LongType).as("total_data_costs_microcents"),
        lit(null).cast(LongType).as("total_profit_microcents"),
        lit(null).cast(LongType).as("total_segment_data_costs_microcents"),
        lit(null).cast(LongType).as("total_feature_costs_microcents")
      ).as("revenue_info"),
  ...
  def f_convert_log_impbus_imptracker_to_log_impbus_impressions(): Column =
    struct(
      ...
      struct(col("*"))
        ...
        .cast(LongType)
        .as("auction_id_64"),
      struct(col("*")).getField("user_id_64").cast(LongType).as("user_id_64"),
      struct(col("*")).getField("tag_id").cast(IntegerType).as("tag_id"),
      struct(col("*")).getField("ip_address").cast(StringType).as("ip_address"),
      lit(0).as("venue_id"),
      struct(col("*"))
      ...
      struct(col("*"))
        ...
        .cast(StringType)
        .as("geo_country"),
      coalesce(coalesce(col("geo_region"), lit("--")),
               struct(col("*")).getField("geo_region").cast(StringType)
      ).as("geo_region"),
      lit("u").as("gender"),
      lit(0).as("age"),
      lit(0).as("bidder_id"),
      ...
      struct(col("*"))
        ...
        .cast(IntegerType)
        .as("publisher_id"),
      struct(col("*")).getField("site_id").cast(IntegerType).as("site_id"),
      struct(col("*"))
      ...
      struct(col("*"))
        ...
        .cast(IntegerType)
        .as("operating_system"),
      struct(col("*")).getField("browser").cast(IntegerType).as("browser"),
      struct(col("*")).getField("language").cast(IntegerType).as("language"),
      ...
      lit(null)
        ...
        .as("tag_sizes"),
      struct(lit(null).cast(IntegerType).as("transaction_event"),
      ...
      struct(
        lit(null).cast(DoubleType).as("iab_view_rate_over_measured"),
        lit(null).cast(DoubleType).as("iab_view_rate_over_total"),
        lit(null).cast(DoubleType).as("predicted_100pv50pd_video_view_rate"),
        lit(null)
          .cast(DoubleType)
          .as("predicted_100pv50pd_video_view_rate_over_total"),
        lit(null).cast(DoubleType).as("video_completion_rate"),
        lit(null).cast(IntegerType).as("view_prediction_source")
      ).as("predicted_video_view_info"),
      struct(lit(null).cast(StringType).as("site_url")).as("auction_url"),
      ...
      struct(lit(null).cast(DoubleType).as("latitude"),
      ...
      coalesce(when(col("region_id").cast(IntegerType) =!= lit(0),
               ...
               struct(col("*")).getField("region_id").cast(IntegerType)
      ).as("region_id"),
      ...
      struct(col("*")).getField("hashed_ip").cast(StringType).as("hashed_ip"),
  ...
  def f_get_media_cost_dollars_cpm(
    ...
    l_media_cost_dollars_cpm = when(coalesce(imp_type, lit(0)) === lit(2),
      ...
      .when(coalesce(imp_type, lit(0)) === lit(7),
            when(!l_payment_type.isin(lit(2), lit(-1), lit(1)),
                 l_buyer_spend_cpm
            ).otherwise(l_media_cost_dollars_cpm)
      )
      .when(
  ...
  def f_zero_pricing_term_amount_if_non_cpm(
    ...
    when(
      ...
      when(
        ...
        temp6282792_UDF(in_pricing_terms, in_pricing_terms, lit(0)).getField(
          "l_pricing_terms"
        )
  ...
  def f_find_personal_identifier(id_type: Column, id_list: Column): Column =
    when(
      is_not_null(
        when(is_not_null(id_list), id_list).otherwise(
          lit(null).cast(
            ArrayType(StructType(
                        List(StructField("identity_type",  IntegerType, true),
                             StructField("identity_value", StringType,  true)
  ...
  def f_string_to_anon_user_info(in1: Column): Column = {
    ...
    retval = struct(
      when(is_not_null(in1),
           raw_data_concat(lit("").cast(BinaryType), murmur(in1))
      ).otherwise(lit(null)).as("user_id")
    )
    retval
  }
  ...
  def f_create_agg_dw_impressions(
    sup_ip_range_lookup_count:                 Column,
    sup_bidder_member_sales_tax_rate_lookup_2: Column,
    sup_common_deal_lookup_2:                  Column,
    sup_bidder_member_sales_tax_rate_lookup:   Column,
    ...
    imp_type = when(is_not_null(col("imp_type").cast(IntegerType)),
    ...
    has_seller_transacted = when(_f_has_transacted.cast(BooleanType) === lit(0),
                                 v_transaction_event_pricing
                                   .getField("seller_transacted")
                                   .cast(BooleanType)
    ).otherwise(has_seller_transacted)
    ...
    media_buy_cost = when(
      imp_type === lit(6),
      when(is_not_null(col("log_impbus_impressions.media_buy_cost")),
           math_min(col("log_impbus_impressions.media_buy_cost"), lit(999.0d))
      ).otherwise(media_buy_cost)
    ).when(is_not_null(col("log_dw_bid.media_buy_cost")),
    ...
    booked_revenue_dollars =
      when(is_not_null(col("log_dw_view.revenue_info.booked_revenue_dollars")),
    ...
    booked_revenue_adv_curr =
      when(is_not_null(col("log_dw_view.revenue_info.booked_revenue_adv_curr")),
    ...
    curator_member_id = when(
      ...
      when(is_not_null(sup_common_deal_lookup),
    ...
    buyer_charges_pricing_terms = when(
      is_not_null(buyer_charges_pricing_terms),
      f_convert_pricing_term_amount(buyer_charges_pricing_terms, lit(1000.0d))
    ).otherwise(buyer_charges_pricing_terms)
    seller_charges_pricing_terms = when(
      is_not_null(seller_charges_pricing_terms),
      f_convert_pricing_term_amount(seller_charges_pricing_terms, lit(1000.0d))
    ).otherwise(seller_charges_pricing_terms)
    creative_id = when(
    ...
    member_sales_tax_rate_pct = when(
      is_not_null(col("log_dw_bid.data_costs")),
      coalesce(
        sup_bidder_member_sales_tax_rate_lookup.getField("sales_tax_rate_pct"),
        lit(0)
      )
    ...
    data_costs = when(
      is_not_null(col("log_dw_bid.data_costs")), {
        ...
        data_costs = f_update_data_costs(
          ...
          coalesce(sup_bidder_member_sales_tax_rate_lookup.getField(
                     "sales_tax_rate_pct"
                   ),
                   lit(0)
          )
    ...
    serving_fees_revshare = when(
      ...
      when(
        !isnull(col("log_dw_bid"))
          ...
          .and(!(f_is_default_or_error_imp(imp_type) === lit(1)))
          .and(!imp_type.isin(lit(5), lit(9), lit(2))),
    ...
    campaign_id = when(is_not_null(col("log_dw_bid_deal")),
    ...
    f_create_agg_dw_impressions_return_11108229(
      curator_member_id,
      discrepancy_allowance,
      should_process_views,
      buyer_member_id,
  ...
  def f_router_is_curated(in1: Column): Column = {
    ...
    has_imp = when(is_not_null(col("log_impbus_impressions")), lit(1))
      .otherwise(has_imp)
      .cast(IntegerType)
    has_preempt = when(is_not_null(col("log_impbus_preempt")), lit(1))
      .otherwise(has_preempt)
      .cast(IntegerType)
    has_curator_bid = when(is_not_null(col("log_dw_bid_curator")), lit(1))
      .otherwise(has_curator_bid)
      .cast(IntegerType)
    (has_imp === lit(1))
  ...
  def f_router_is_quarantined(
    ...
    var imp_type: org.apache.spark.sql.Column =
      col("imp_type").cast(IntegerType).cast(IntegerType)
    var seller_member_id: org.apache.spark.sql.Column = col(
      "log_impbus_impressions.seller_member_id"
    ...
    var campaign_group_id: org.apache.spark.sql.Column =
      col("campaign_group_id").cast(IntegerType).cast(IntegerType)
    ...
    var log_impbus_impressions_pricing_count: org.apache.spark.sql.Column =
      coalesce(col("log_impbus_impressions_pricing_count").cast(IntegerType),
               lit(0)
      ).cast(IntegerType)
    var gross_payment_value_microcents: org.apache.spark.sql.Column = coalesce(
      col(
    ...
    quarantine = when(
      is_not_null(col("log_dw_bid.member_id").cast(IntegerType))
        .and(
          is_not_null(
            coalesce(
              col("log_impbus_preempt.buyer_member_id").cast(IntegerType),
      ...
      lit(1)
        ...
        is_not_null(col("log_dw_bid_last.member_id").cast(IntegerType))
          .and(is_not_null(col("log_dw_bid.member_id").cast(IntegerType)))
          .and(
            col("log_dw_bid_last.member_id").cast(IntegerType) =!= col(
      ...
      .when(
        is_not_null(col("log_dw_bid_last.advertiser_id").cast(IntegerType))
          .and(is_not_null(col("log_dw_bid.advertiser_id").cast(IntegerType)))
          .and(
            col("log_dw_bid_last.advertiser_id").cast(IntegerType) =!= col(
              "log_dw_bid.advertiser_id"
            ).cast(IntegerType)
          ),
        lit(1)
      )
      .when(
        is_not_null(col("log_dw_bid_last.campaign_group_id").cast(IntegerType))
          .and(
            is_not_null(col("log_dw_bid.campaign_group_id").cast(IntegerType))
          )
          .and(
            col("log_dw_bid_last.campaign_group_id").cast(IntegerType) =!= col(
              "log_dw_bid.campaign_group_id"
            ).cast(IntegerType)
          ),
        lit(1)
      )
  ...
  def f_router_is_transacted(in1: Column): Column = {
    ...
    has_imp = when(is_not_null(col("log_impbus_impressions")), lit(1))
      ...
      .cast(IntegerType)
    is_delivered = when(
      is_not_null(col("log_impbus_impressions.is_delivered").cast(IntegerType))
        .and(
