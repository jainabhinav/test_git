...
object advertiser_id_by_insertion_order_id {
...
type sup_bidder_insertion_order =
record
  sfixed32_t buyer_member_id;
  sfixed32_t advertiser_id;
  sfixed32_t insertion_order_id;
end;
constant
record
  string(int) name;
...
end[int] sup_bidder_insertion_order_message_types =
[vector
  [record
    name "sup_bidder_insertion_order"
    field_infos [vector
                  [record name "buyer_member_id" number 1 type_code 4 message_type -1 optional 0],
                  [record name "advertiser_id" number 2 type_code 4 message_type -1 optional 0],
                  [record name "insertion_order_id" number 3 type_code 4 message_type -1 optional 0]]]];
metadata type = sup_bidder_insertion_order ;"""
      ...
      writer.save(
        s"${Config.XR_LOOKUP_DATA}/data_team/lookups/trx_tl_ad_request_trans_path_core_processing_pb/advertiser_id_by_insertion_order_id.${Config.XR_BUSINESS_DATE}${Config.XR_BUSINESS_HOUR}.dat"
      )
    } catch {
      case e: Error =>
