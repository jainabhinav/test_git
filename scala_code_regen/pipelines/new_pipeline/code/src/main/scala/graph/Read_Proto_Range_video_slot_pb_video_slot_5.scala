...
object Read_Proto_Range_video_slot_pb_video_slot_5 {
...
end[int] video_slot_message_types =
[vector
  [record
    name "video_slot"
    field_infos [vector
                  ...
                  [record name "video_context" number 3 type_code 4 message_type -1 optional 1]]]];
metadata type = video_slot;
metadata type = "video_slot" ;""")
