...
object Read_Proto_Range_log_impbus_impressions_pricing_pb_log_impbus_impressions_pricing {
...
end[int] log_impbus_impressions_pricing_message_types =
[vector
  [record
    name "pricing_term"
    field_infos [vector
  ...
  [record
    name "log_trade_agreement_info"
    field_infos [vector
                  [record name "applied_term_id" number 1 type_code 4 message_type -1 optional 1],
                  [record name "applied_term_type" number 2 type_code 4 message_type -1 optional 1],
                  [record name "targeted_term_ids" number 3 type_code 20 message_type -1 optional 1]]],
  [record
  ...
  [record
    name "log_impbus_impressions_pricing"
    field_infos [vector
                  ...
                  [record name "buyer_charges" number 3 type_code 9 message_type 1 optional 1],
                  [record name "seller_charges" number 4 type_code 9 message_type 1 optional 1],
                  [record name "buyer_spend" number 5 type_code 1 message_type -1 optional 1],
                  [record name "seller_revenue" number 6 type_code 1 message_type -1 optional 1],
                  [record name "rate_card_auction_type" number 7 type_code 4 message_type -1 optional 1],
                  [record name "rate_card_media_type" number 8 type_code 4 message_type -1 optional 1],
                  [record name "direct_clear" number 9 type_code 7 message_type -1 optional 1],
                  [record name "auction_timestamp" number 10 type_code 1 message_type -1 optional 0],
                  [record name "instance_id" number 11 type_code 4 message_type -1 optional 1],
                  [record name "two_phase_reduction_applied" number 13 type_code 7 message_type -1 optional 1],
                  [record name "trade_agreement_id" number 14 type_code 4 message_type -1 optional 1],
                  [record name "log_timestamp" number 15 type_code 1 message_type -1 optional 1],
                  [record name "trade_agreement_info" number 16 type_code 9 message_type 2 optional 1],
                  [record name "is_buy_it_now" number 17 type_code 7 message_type -1 optional 1],
                  [record name "net_buyer_spend" number 18 type_code 1 message_type -1 optional 1],
                  [record name "impression_event_pricing" number 19 type_code 9 message_type 3 optional 1],
                  [record name "counterparty_ruleset_type" number 20 type_code 4 message_type -1 optional 1],
                  [record name "estimated_audience_imps" number 21 type_code 2 message_type -1 optional 1],
                  [record name "audience_imps" number 22 type_code 2 message_type -1 optional 1]]]];
metadata type = log_impbus_impressions_pricing;
metadata type = "log_impbus_impressions_pricing" ;""")
