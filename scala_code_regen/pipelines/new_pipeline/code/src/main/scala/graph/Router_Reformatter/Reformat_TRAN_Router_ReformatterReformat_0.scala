      ...
      coalesce(
        ...
        when(
          ...
          f_update_data_costs_deal(
            ...
            coalesce(col("_sup_bidder_member_sales_tax_rate_LOOKUP1").getField(
                       "sales_tax_rate_pct"
                     ),
                     lit(0)
            )
          ...
          when(
            ...
            aggregate(
              f_update_data_costs_deal(
                ...
                coalesce(col("_sup_bidder_member_sales_tax_rate_LOOKUP")
            ...
            .and(
              is_not_null(
                when(
                  ...
                  f_update_data_costs_deal(
                    col("log_dw_bid_curator.data_costs"),
                    coalesce(col("_sup_bidder_member_sales_tax_rate_LOOKUP1")
                               .getField("sales_tax_rate_pct"),
                             lit(0)
                    )
                  )
