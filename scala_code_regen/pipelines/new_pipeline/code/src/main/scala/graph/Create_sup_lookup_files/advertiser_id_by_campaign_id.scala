...
object advertiser_id_by_campaign_id {
...
metadata type = sup_buy_side_object_hierarchy ;"""
      ...
      writer.save(
        s"${Config.XR_LOOKUP_DATA}/data_team/lookups/trx_tl_ad_request_trans_path_core_processing_pb/advertiser_id_by_campaign_id.${Config.XR_BUSINESS_DATE}${Config.XR_BUSINESS_HOUR}.dat"
      )
    } catch {
      case e: Error =>
