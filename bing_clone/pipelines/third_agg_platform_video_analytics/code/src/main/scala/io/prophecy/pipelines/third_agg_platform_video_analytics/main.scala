package io.prophecy.pipelines.third_agg_platform_video_analytics

import io.prophecy.libs._
import io.prophecy.pipelines.third_agg_platform_video_analytics.config._
...
import io.prophecy.pipelines.third_agg_platform_video_analytics.graph._
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/third_agg_platform_video_analytics"
    )
