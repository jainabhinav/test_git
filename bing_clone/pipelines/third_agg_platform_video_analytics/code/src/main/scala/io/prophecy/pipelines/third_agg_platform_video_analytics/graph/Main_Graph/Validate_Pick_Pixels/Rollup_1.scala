  ...
  def apply(context: Context, in: DataFrame): DataFrame =
    in.groupBy(col("auction_id_64").cast(LongType).as("auction_id_64"),
      ...
      .agg(
        ...
        last(col("post_click_conv")).cast(IntegerType).as("post_click_conv"),
        last(col("post_view_conv")).cast(IntegerType).as("post_view_conv"),
        last(col("post_click_revenue")).as("post_click_revenue"),
        last(col("post_view_revenue")).as("post_view_revenue"),
        ...
        last(col("pixel_id")).cast(IntegerType).as("pixel_id"),
        last(col("booked_revenue")).as("booked_revenue"),
        ...
        last(col("order_id")).as("order_id"),
        last(col("external_data")).as("external_data"),
        ...
        last(col("post_click_crossdevice_conv"))
          .cast(IntegerType)
          .as("post_click_crossdevice_conv"),
        last(col("post_view_crossdevice_conv"))
          .cast(IntegerType)
          .as("post_view_crossdevice_conv"),
        last(col("revenue_event_type_id"))
          .cast(IntegerType)
          .as("revenue_event_type_id"),
        last(col("post_click_crossdevice_revenue"))
          .as("post_click_crossdevice_revenue"),
        last(col("post_view_crossdevice_revenue"))
        ...
        last(col("universal_pixel_rule_version_id"))
          .cast(IntegerType)
        ...
        last(col("conversion_device_type"))
          .cast(IntegerType)
          .as("conversion_device_type"),
        last(col("conversion_device_make_id"))
          .cast(IntegerType)
          .as("conversion_device_make_id"),
        last(col("universal_pixel_fire_id")).as("universal_pixel_fire_id"),
        ...
        last(col("post_click_ip_conv"))
          .cast(IntegerType)
          .as("post_click_ip_conv"),
        last(col("post_view_ip_conv"))
          .cast(IntegerType)
