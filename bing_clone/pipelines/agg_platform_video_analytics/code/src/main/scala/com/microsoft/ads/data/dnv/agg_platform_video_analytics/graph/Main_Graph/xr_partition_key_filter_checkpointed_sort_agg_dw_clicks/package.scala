...
import com.microsoft.ads.data.dnv.agg_platform_video_analytics.graph.Main_Graph.xr_partition_key_filter_checkpointed_sort_agg_dw_clicks.config._
...
package object xr_partition_key_filter_checkpointed_sort_agg_dw_clicks {
  ...
  def apply(context: Context, in: DataFrame): DataFrame = {
    val df_Filter_by_Expression_5 = Filter_by_Expression_5(context, in)
