...
object source_stage_platform_video_analytics_pq {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg: String =
      "hdfs:/data_team/team_user_space/mx429j/stage_platform_video_analytics_pq".trim
    def isPathAbsoluteArg:      Boolean = false
    def partitionDateOrHourArg: String  = context.config.system.startDate.trim
