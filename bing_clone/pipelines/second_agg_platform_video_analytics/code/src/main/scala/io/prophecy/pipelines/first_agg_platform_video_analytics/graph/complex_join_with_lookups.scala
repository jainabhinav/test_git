  ...
  def apply(context: Context, in0: DataFrame, in1: DataFrame): DataFrame = {
    ...
    println("step persist time: " + Instant.now().atZone(ZoneId.of("America/Chicago"))) 
      ...
      val out0 = joinedDF
        ...
        createLookupStruct("in1").as("_sup_bidder_advertiser_pb_LOOKUP1"),  // Include the newly generated columns
        createLookupStruct("in2").as("_sup_bidder_advertiser_pb_LOOKUP5"),
        createLookupStruct("in3").as("_sup_bidder_advertiser_pb_LOOKUP7"),
        createLookupStruct("in4").as("_sup_bidder_advertiser_pb_LOOKUP3"),
