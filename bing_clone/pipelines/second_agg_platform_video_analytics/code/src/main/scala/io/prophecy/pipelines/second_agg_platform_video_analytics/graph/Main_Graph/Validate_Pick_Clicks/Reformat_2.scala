...
object Reformat_2 {
  ...
  def apply(context: Context, in: DataFrame): DataFrame =
    in.select(
      ...
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.predict_type")
        ),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.predict_type")
        ),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.predict_type")
        ),
        col("others.predict_type")
      ).as("predict_type"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
      ...
      coalesce(
        ...
        col("others.control_pct").cast(DoubleType)
      ).as("control_pct"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
      ...
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.total_partner_fees_microcents").cast(LongType)
        ).cast(LongType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.total_partner_fees_microcents").cast(LongType)
        ).cast(LongType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.total_partner_fees_microcents").cast(LongType)
        ).cast(LongType),
        col("others.total_partner_fees_microcents").cast(LongType)
      ).as("total_partner_fees_microcents"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.net_buyer_spend")
        ).cast(DoubleType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.net_buyer_spend")
        ).cast(DoubleType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.net_buyer_spend")
        ).cast(DoubleType),
        col("others.net_buyer_spend").cast(DoubleType)
      ).as("net_buyer_spend"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.net_media_cost_dollars_cpm")
        ).cast(DoubleType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.net_media_cost_dollars_cpm")
        ).cast(DoubleType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.net_media_cost_dollars_cpm")
        ).cast(DoubleType),
        col("others.net_media_cost_dollars_cpm").cast(DoubleType)
      ).as("net_media_cost_dollars_cpm"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.total_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.total_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.total_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        col("others.total_data_costs_microcents").cast(LongType)
      ).as("total_data_costs_microcents"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.total_profit_microcents").cast(LongType)
        ).cast(LongType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.total_profit_microcents").cast(LongType)
        ).cast(LongType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.total_profit_microcents").cast(LongType)
        ).cast(LongType),
        col("others.total_profit_microcents").cast(LongType)
      ...
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.total_segment_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.total_segment_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.total_segment_data_costs_microcents").cast(LongType)
        ).cast(LongType),
        col("others.total_segment_data_costs_microcents").cast(LongType)
      ).as("total_segment_data_costs_microcents"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.total_feature_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.total_feature_costs_microcents").cast(LongType)
        ).cast(LongType),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.total_feature_costs_microcents").cast(LongType)
        ).cast(LongType),
        col("others.total_feature_costs_microcents").cast(LongType)
      ...
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.buyer_line_item_currency")
        ),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.buyer_line_item_currency")
        ),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.buyer_line_item_currency")
        ),
        col("others.buyer_line_item_currency")
      ).as("buyer_line_item_currency"),
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.deal_line_item_currency")
        ),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.deal_line_item_currency")
        ),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.deal_line_item_currency")
        ),
        col("others.deal_line_item_currency")
      ...
      coalesce(
        when(is_not_null(col("rtb")).and(is_not_null(col("resold"))),
             col("resold.is_residential_ip")
        ),
        when(col("rtb").isNull.and(is_not_null(col("resold"))),
             col("resold.is_residential_ip")
        ),
        when(is_not_null(col("rtb")).and(col("resold").isNull),
             col("rtb.is_residential_ip")
        ),
        col("others.is_residential_ip")
