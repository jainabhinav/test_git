package io.prophecy.pipelines.first_agg_platform_video_analytics_hourly.config

import pureconfig._
import pureconfig.generic.ProductHint
import io.prophecy.libs._
import io.prophecy.pipelines.first_agg_platform_video_analytics_hourly.graph.Create_sup_lookup_files.config.{
