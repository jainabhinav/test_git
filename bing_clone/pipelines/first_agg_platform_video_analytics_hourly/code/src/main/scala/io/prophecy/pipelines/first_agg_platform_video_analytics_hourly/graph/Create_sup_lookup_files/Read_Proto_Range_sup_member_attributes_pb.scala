...
object Read_Proto_Range_sup_member_attributes_pb {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.sup_member_attributes_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "sup_member_attributes".trim
