...
object Read_Proto_Range_sup_bidder_advertiser_pb {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.sup_bidder_advertiser_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "sup_bidder_advertiser".trim
