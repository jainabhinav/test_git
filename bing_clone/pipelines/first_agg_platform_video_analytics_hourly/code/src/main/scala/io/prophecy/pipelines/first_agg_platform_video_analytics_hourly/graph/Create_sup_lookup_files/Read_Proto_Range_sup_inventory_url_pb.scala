...
object Read_Proto_Range_sup_inventory_url_pb {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.sup_inventory_url.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "sup_inventory_url".trim
