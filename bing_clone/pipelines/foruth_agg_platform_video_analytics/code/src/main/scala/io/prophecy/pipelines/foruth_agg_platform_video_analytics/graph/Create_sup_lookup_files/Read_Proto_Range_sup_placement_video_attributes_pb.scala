...
object Read_Proto_Range_sup_placement_video_attributes_pb {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg: String =
      Config.datasets.inputs.sup_placement_video_attributes_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "sup_placement_video_attributes".trim
