...
object Read_Proto_Range_sup_creative_media_subtype_pb {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg: String =
      Config.datasets.inputs.sup_creative_media_subtype_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "sup_creative_media_subtype".trim
