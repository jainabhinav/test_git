package io.prophecy.pipelines.second_agg_platform_video_analytics_hourly

import io.prophecy.libs._
import io.prophecy.pipelines.second_agg_platform_video_analytics_hourly.config._
...
import io.prophecy.pipelines.second_agg_platform_video_analytics_hourly.graph._
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/second_agg_platform_video_analytics_hourly"
    )
    registerUDFs(spark)
