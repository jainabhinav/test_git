...
object Read_Proto_Range_agg_platform_video_requests_transactable_pq_agg_platform_video_requests_transactable_0_to_5 {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg: String =
      Config.datasets.inputs.agg_platform_video_requests_transactable_pq.trim
    ...
    def fromArg:            Int     = if ("-5".trim.isEmpty) 0 else "-5".trim.toInt
