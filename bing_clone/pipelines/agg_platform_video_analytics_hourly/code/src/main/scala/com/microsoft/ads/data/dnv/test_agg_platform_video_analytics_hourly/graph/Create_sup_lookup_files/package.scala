...
import com.microsoft.ads.data.dnv.test_agg_platform_video_analytics_hourly.graph.Create_sup_lookup_files.config._
...
package object Create_sup_lookup_files {
  ...
  def apply(context: Context): Subgraph3 = {
    ...
    val df_Read_Proto_Range_sup_inventory_url_pb =
      Read_Proto_Range_sup_inventory_url_pb(context)
    ...
    val df_Reformat_sup_inventory_url_pb = Reformat_sup_inventory_url_pb(
      context,
      df_Read_Proto_Range_sup_inventory_url_pb
    )
    ...
    val df_sup_inventory_url_pb_lookup_dedup2 =
      sup_inventory_url_pb_lookup_dedup2(context,
                                         df_Reformat_sup_inventory_url_pb
      )
    ...
    (df_sup_inventory_url_pb_lookup_dedup2,
