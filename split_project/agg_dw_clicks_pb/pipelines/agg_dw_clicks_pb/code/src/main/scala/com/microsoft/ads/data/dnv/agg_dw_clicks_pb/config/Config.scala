...
import com.microsoft.ads.data.dnv.agg_dw_clicks_pb.graph.agg_dw_clicks_initialize_lookups.config.{
  Config => agg_dw_clicks_initialize_lookups_Config
}
import com.microsoft.ads.data.dnv.agg_dw_clicks_pb.graph.External_Clicks.config.{
  Config => External_Clicks_Config
}

case class Config(
  agg_dw_clicks_initialize_lookups: agg_dw_clicks_initialize_lookups_Config =
    agg_dw_clicks_initialize_lookups_Config(),
  External_Clicks:  External_Clicks_Config = External_Clicks_Config(),
