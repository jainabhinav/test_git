...
object Read_Proto_Range_agg_dw_curator_impressions_agg_dw_curator_impressions_2 {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg: String =
      Config.datasets.inputs.agg_dw_curator_impressions_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "agg_dw_curator_impressions".trim
