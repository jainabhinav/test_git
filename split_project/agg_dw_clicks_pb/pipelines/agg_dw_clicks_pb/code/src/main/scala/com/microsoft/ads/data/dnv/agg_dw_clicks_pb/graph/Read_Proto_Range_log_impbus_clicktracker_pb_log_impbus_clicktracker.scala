...
object Read_Proto_Range_log_impbus_clicktracker_pb_log_impbus_clicktracker {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.log_impbus_clicktracker_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "log_impbus_clicktracker".trim
