...
object Read_Proto_Range_msan_map_pb_msan_map {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.agg_msan_map_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "msan_map".trim
    ...
    def allowEmptyInputArg: Boolean = true
