...
object Read_Proto_Range_log_dw_clicktracker_pb_log_dw_clicktracker {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.log_dw_clicktracker_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "log_dw_clicktracker".trim
