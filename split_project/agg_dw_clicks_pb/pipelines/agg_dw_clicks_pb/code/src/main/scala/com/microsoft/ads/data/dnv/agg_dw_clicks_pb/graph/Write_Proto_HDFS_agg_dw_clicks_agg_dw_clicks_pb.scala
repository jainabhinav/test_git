...
object Write_Proto_HDFS_agg_dw_clicks_agg_dw_clicks_pb {
  ...
  def apply(context: Context, in: DataFrame): Unit = {
    ...
    def pathArg:               String  = Config.datasets.outputs.agg_dw_clicks_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "agg_dw_clicks".trim
