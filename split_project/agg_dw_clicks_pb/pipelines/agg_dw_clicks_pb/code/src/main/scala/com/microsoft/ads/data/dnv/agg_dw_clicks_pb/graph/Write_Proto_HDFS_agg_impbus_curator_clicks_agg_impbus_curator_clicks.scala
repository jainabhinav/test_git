...
object Write_Proto_HDFS_agg_impbus_curator_clicks_agg_impbus_curator_clicks {
  ...
  def apply(context: Context, in: DataFrame): Unit = {
    ...
    def pathArg: String =
      Config.datasets.outputs.agg_impbus_curator_clicks_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "agg_impbus_curator_clicks".trim
