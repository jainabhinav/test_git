...
object External_Clicks__Read_Proto_Range_log_impbus_click_pb_2 {
  ...
  def apply(context: Context): DataFrame = {
    ...
    def pathArg:               String  = Config.datasets.inputs.log_impbus_click_pb.trim
    def isPathAbsoluteArg:     Boolean = false
    def protobufSchemaNameArg: String  = "log_impbus_click".trim
